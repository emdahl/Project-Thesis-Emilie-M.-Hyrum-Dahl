...
\begin{titlepage}
	\centering
    \vspace*{0.5 cm}
    \includegraphics[scale = 0.3]{Images/ntnuu}\\[1.0 cm]	% University Logo
    \begin{centering}
    \textsc{\Large Norwegian University of Science and Technology}\\[1.0 cm]	% University Name
    \end{centering}
...
\include{Chapters/today}
\include{Chapters/theory} % could be called Methodology or methods or any filename  % could be results% could be results
