...
\begin{figure}[H]
 ...
 \sbox{\FigBox}{\includegraphics[scale=0.36]{Images/appendix/pvc-soft-pristine-clear.eps}}
  ...
  \end{minipage}
  % Save second image 
  \caption[Comparing PP and PVC]{A comparison of the resulting signature for PP and PVC - both clear-colored}
...
\begin{figure}[H]
 ...
 \sbox{\FigBox}{\includegraphics[scale=0.4]{Images/results/specred.png}}
  ...
  \end{minipage}
  % Save second image 
  \caption[Comparing Red PE-HD with Visible Light Spectrum]{A comparison of the resulting signature for red-colored PE-HD and the visible light spectrum-reference}
  \label{fig:red}
\end{figure}
...
\begin{figure}[H]
 ...
 \sbox{\FigBox}{\includegraphics[scale=0.4]{Images/results/specblue.png}}
  ...
  \end{minipage}
  % Save second image 
  \caption[Comparing Blue PE-HD with Visible Light Spectrum]{A comparison of the resulting signature for blue-colored PE-LD and the visible light spectrum-reference}
  \label{fig:blue}
\end{figure}
...
\begin{figure}[H]
 ...
 \sbox{\FigBox}{\includegraphics[scale=0.36]{Images/appendix/pet-amorphous-pristine-clear.eps}}
  ...
  \end{minipage}
  % Save second image 
  \caption[Comparing PET at Different Sizes]{A comparison of a large PET piece from a Farris bottle and tiny PET Amorphous pieces}
  \label{fig:size}
\end{figure}
\noindent
...
\begin{figure}[H]
 ...
 \sbox{\FigBox}{\includegraphics[scale=0.56]{Images/results/PCA_plastics_and_biology_cont_pc2.png}}
  ...
  \end{minipage}
  % Save second image 
  \caption[Contribution Plot Plastics and Biological Pigments]{Contribution plots for the PCA with plastic and biological samples}
